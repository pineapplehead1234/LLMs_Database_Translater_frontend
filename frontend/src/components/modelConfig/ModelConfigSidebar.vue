<template>
    <div class="model-config-sidebar">
        ...
        <div class="model-list">
            <div v-for="model in store.llms" :key="model.id" class="model-item"
                :class="{ active: model.id === store.selectedId }" @click="store.setSelectedId(model.id)">
...
.tag-main {
    background: var(--model-tag-main-bg);
    color: var(--model-tag-main-color);
}

.tag-mt {
    background: var(--model-tag-mt-bg);
    color: var(--model-tag-mt-color);
}

.tag-general {
    background: var(--model-tag-general-bg);
    color: var(--model-tag-general-color);
}
